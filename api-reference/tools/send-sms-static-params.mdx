...
description: 'Complete reference for the static_params object when creating or updating a send_sms tool via the API.'
slug: api-reference/tools/send-sms-static-params
---

When creating a tool with `type: "send_sms"` via the [Create Tool](/api-reference/tools/create-tool) endpoint, the `static_params` object configures how the SMS message is generated and sent.
