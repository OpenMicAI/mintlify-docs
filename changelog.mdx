...
<Update label="October 2025" rss={{ title: "October Product Updates", description: "GoHighLevel integration, smarter workflows, and automation improvements" }}>
  ...
  * Introduced **GoHighLevel (GHL)** integration with built-in tools for contact management. Agents can now automatically **fetch existing contacts** and **create new ones** in GoHighLevel during live calls, allowing smoother CRM syncing and more personalized caller experiences.
