...
class RawPhoneNumbersClient:
    ...
    def get_phone_number(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/phone-numbers/{jsonable_encoder(uid)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def link_bot_to_phone_number(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[LinkBotToPhoneNumberResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=LinkBotToPhoneNumberResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawPhoneNumbersClient:
    ...
    async def link_bot_to_phone_number(
        ...
        *,
        ...
        direction: LinkBotToPhoneNumberRequestDirection,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[LinkBotToPhoneNumberResponse]:
        """
        Link a bot (agent) to a phone number for inbound/outbound calls.
