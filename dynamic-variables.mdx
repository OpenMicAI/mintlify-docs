...
<ArcadeEmbed
	url="https://demo.arcade.software/kZVyBek8IzbBBQSzz6iw?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true"
	title="Set Default Values for Dynamic Variables in OpenMic Bot"
/>
...
| `{{session_duration}}` | Human-readable duration since session start                 | "45 seconds"            |

### Calendar variables

| Variable                        | Description                                                         | Example                       |
| ------------------------------- | ------------------------------------------------------------------- | ----------------------------- |
| `{{current_calendar}}`          | 14-day calendar in America/Los_Angeles                              | Calendar data in PST timezone |
