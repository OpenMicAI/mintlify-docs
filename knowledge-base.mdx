...
See how to set up and use a Knowledge Base:
...
Once you've created and populated your knowledge base, connect it to your agent:
...
<Frame>
  <img
    ...
    alt="Connect knowledge base to agent"
  />
</Frame>

<Check>
  Your agent will now automatically reference the knowledge base during
  conversations!
</Check>
