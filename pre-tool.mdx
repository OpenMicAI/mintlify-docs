...
Pre-tool webhooks are currently implemented for the following tools:

<CardGroup cols={3}>
	<Card title="Calendar Check" icon="calendar-days" iconType="solid">
		Validate availability before checking schedules.
	</Card>

{" "}
<Card title="Calendar Booking" icon="calendar-plus" iconType="solid">
	Inject booking parameters and preferences.
</Card>

{" "}
<Card title="Transfer Call" icon="phone-arrow-up-right" iconType="solid">
	Dynamically determine transfer destinations.
</Card>
