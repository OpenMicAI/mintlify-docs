...
## Four ways to get an agent into a browser

<CardGroup cols={2}>
	<Card title="Web SDK" icon="code" href="/web-calls/web-sdk">
		Build calls into your own UI — live transcription, controls, and per-call
		dynamic variables.
	</Card>
...
| | Web SDK | Voice widget | Chat widget | Share link |
| --- | --- | --- | --- | --- |
| Modality | Voice | Voice | Text | Voice **and** text |
| Integration effort | npm package, your own UI | One script tag | One script tag | None — copy a URL |
| Lives on | Your product | Your website | Your website | An OpenMic-hosted page |
| Needs a public API key | Yes | Yes | Yes | No |
| Good for | AI interviewers, in-app copilots, any custom call UI | Demos, support lines, "talk to sales" | Support deflection, lead capture | Sharing an agent with a client or teammate |
| Lifetime | Permanent | Permanent | Permanent | Expires after 24 hours |
