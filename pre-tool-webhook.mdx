...
description: Dynamically configure tool behavior and inject real-time data before specific tools execute.
---
...
<img 
  src="/images/pre-tool-webhook.png" 
  alt="Showing the configuration for pre-tool webhook"
  height="300"
